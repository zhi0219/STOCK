...
$inventoryStep = Invoke-RepoDoctorStep -Name "inventory_repo" -Command $pythonCmd.Source -Arguments @("-m", "tools.inventory_repo", "--write-docs", "--artifacts-dir", $script:RepoDoctorArtifactsDir)
...
$prReadyStep = Invoke-RepoDoctorStep -Name "verify_pr_ready" -Command $pythonCmd.Source -Arguments @("-m", "tools.verify_pr_ready", "--artifacts-dir", $script:RepoDoctorArtifactsDir)
